...
export const ButtonContainer = forwardRef(
  ({ selectionStates, updateSelectionStates }: ButtonContainerProps, ref) => {
    ...
    return (
      <Box display={"flex"} gap={2}>
        <Button
          disabled={
            (selectionStates.kiss && currentState !== "kiss") ||
            (currentState !== "none" && currentState !== "kiss")
          }
          sx={IconButtonStyle(currentState === "kiss")}
        ...
        <Button
          disabled={
            (selectionStates.marry && currentState !== "marry") ||
            (currentState !== "none" && currentState !== "marry")
          }
          sx={IconButtonStyle(currentState === "marry")}
        ...
        <Button
          disabled={
            (selectionStates.kill && currentState !== "kill") ||
            (currentState !== "none" && currentState !== "kill")
          }
          sx={IconButtonStyle(currentState === "kill")}
