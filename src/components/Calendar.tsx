...
export default function Calendar({ title, data, cellStyling }: CalendarProps) {
        ...
        <Box>
          ...
          >
            ...
            <Button
              ...
              onClick={() => handleDateChange(DateTime.now().toUTC())}
            >
              Today
            </Button>
          </Box>
                      ...
                      return allEntries.map((entry, index) => (
                        <Typography
                          ...
                          sx={{
                            ...
                            fontWeight: "bold",
                            color:
                              COLORS.calendar.entryColors[
                                index % COLORS.calendar.entryColors.length
                              ],
                          }}
                        >
                          {entry.value}
