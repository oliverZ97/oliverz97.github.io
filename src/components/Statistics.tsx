      ...
      <Box sx={{ display: "flex", justifyContent: "space-between", gap: 2, marginTop: 2 }}>
        <Box>
          ...
          <StatsEntry
            ...
            value={userStats.totalCharactersGuessed}
          />
          <StatsEntry
            title="Total Daily Character Images Guessed"
            value={userStats.totalCharacterImagesGuessed}
          />
          ...
          <StatsEntry
            ...
            value={userStats.totalBlurredCharactersGuessed}
          />
        ...
        <Box>
          ...
          <StatsEntry
            ...
            value={userStats.kissMarryKillGamesPlayed}
          />
